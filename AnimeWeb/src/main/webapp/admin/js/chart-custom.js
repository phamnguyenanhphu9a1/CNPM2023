...
const $tableID = $("#table"),
	...
	newTr = '\n  <tr id="addChapter"> \n' +
		...
		'                                            </td>\n' +
		'                                            <td>\n' +
		'                                          <span class="table-remove"><button type="button" class="btn btn-sm iq-bg-success btn-rounded btn-sm my-0" onclick="startUploading(this,`insert`)"">Submit</button>\n' +

		'                                          <span class="table-remove"><button type="button" class="btn iq-bg-danger btn-rounded btn-sm my-0">Remove</button>\n' +
		'                                          </span>\n' +
		'                                            </td>\n' +
		'                                        </tr>';
	...
	$(".file-upload").on("change", function() {
		...
		! function(e) {
			if (e.files && e.files[0]) {
				...
				t.onload = function(e) {
					$(parent).find(".profile-pic").attr("src", e.target.result)
